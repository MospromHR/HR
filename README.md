...
Также некоторое время доступен уже развернутый [демо-стенд](ttps://hackathon.silkslime.ru/), который является полной копией приложения, запущенного по данной инструкции.
